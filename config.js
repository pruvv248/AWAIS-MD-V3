...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "kd5x2IST#THDns5UfEvFwFbvOn5CL6wPBNg3kdF13rKLuuxCTD5U",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "꧁ঔৣ✞𝕻𝕮✞ঔৣ꧂", //replace with your name 
    OWNER_NUMBER: process.env.OWNER_NUMBER || "9231828",// add your bot owner number
    DEV: process.env.DEV || "2348118306878", //replace with your whatsapp number
    AUTOLIKESTATUS: process.env.AUTOLIKESTATUS || "true",
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
    AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "`𝒚𝒐𝒖𝒓 𝒔𝒕𝒂𝒕𝒖𝒔 𝒔𝒆𝒆𝒏 𝒋𝒖𝒔𝒕 𝒏𝒐𝒘 𝒃𝒚 ꧁ঔৣ✞𝕻𝕮✞ঔৣ꧂`",
